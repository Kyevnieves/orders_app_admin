...
---- AGREGANDO FUNCION CANCELAR PEDIDO
ALTER TABLE `orders` ADD `cancelado` BOOLEAN NOT NULL AFTER `enviado`;
...
--- AGREGANDO COLUMNA MONTH PARA FILTRAR
ALTER TABLE `orders` ADD `month` INT NOT NULL AFTER `createdAt`;
...
SELECT COUNT( *) FROM orders WHERE createdAt BETWEEN '2023-01-01' AND '2023-01-31'

SELECT COUNT(*) FROM orders WHERE createdAt BETWEEN '2023-02-01' AND '2023-02-28'

SELECT COUNT(*) FROM orders WHERE createdAt BETWEEN '2023-03-01' AND '2023-03-31'

SELECT COUNT(*) FROM orders WHERE createdAt BETWEEN '2023-04-01' AND '2023-04-30'

SELECT COUNT(*) FROM orders WHERE createdAt BETWEEN '2023-05-01' AND '2023-05-31'

SELECT COUNT(*) FROM orders WHERE createdAt BETWEEN '2023-06-01' AND '2023-06-30'

SELECT COUNT(*) FROM orders WHERE createdAt BETWEEN '2023-07-01' AND '2023-07-31'

SELECT COUNT(*) FROM orders WHERE createdAt BETWEEN '2023-08-01' AND '2023-08-31'

SELECT COUNT(*) FROM orders WHERE createdAt BETWEEN '2023-09-01' AND '2023-09-30'

SELECT COUNT(*) FROM orders WHERE createdAt BETWEEN '2023-10-01' AND '2023-10-31'

SELECT COUNT(*) FROM orders WHERE createdAt BETWEEN '2023-11-01' AND '2023-11-30'

SELECT COUNT(*) FROM orders WHERE createdAt BETWEEN '2023-12-01' AND '2023-12-31'